...
import mainTool.ast.declaration.IdentifierDecl;
import mainTool.ast.declaration.IdentifierDeclType;
import mainTool.ast.expressions.*;
import mainTool.ast.expressions.binaryExpressions.*;
import mainTool.ast.expressions.expressionHolders.*;
import mainTool.ast.expressions.memberAccesses.MemberAccess;
import mainTool.ast.expressions.memberAccesses.PtrMemberAccess;
import mainTool.ast.expressions.postfixExpressions.CallExpression;
import mainTool.ast.expressions.postfixExpressions.DeleteExpression;
import mainTool.ast.expressions.postfixExpressions.IncDecOp;
import mainTool.ast.expressions.postfixExpressions.NewExpression;
import mainTool.ast.expressions.primaryExpression.*;
import mainTool.ast.statements.*;
