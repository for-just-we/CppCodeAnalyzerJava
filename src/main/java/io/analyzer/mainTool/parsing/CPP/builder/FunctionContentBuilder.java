...
import io.analyzer.mainTool.ast.declaration.IdentifierDecl;
import io.analyzer.mainTool.ast.expressions.*;
import io.analyzer.mainTool.ast.expressions.binaryExpressions.*;
import io.analyzer.mainTool.ast.expressions.expressionHolders.*;
import io.analyzer.mainTool.ast.expressions.primaryExpression.*;
import io.analyzer.mainTool.ast.statements.*;
...
import io.analyzer.mainTool.ast.expressions.memberAccesses.PtrMemberAccess;
import io.analyzer.mainTool.ast.expressions.postfixExpressions.CallExpression;
import io.analyzer.mainTool.ast.expressions.postfixExpressions.DeleteExpression;
import io.analyzer.mainTool.ast.expressions.postfixExpressions.IncDecOp;
import io.analyzer.mainTool.ast.expressions.postfixExpressions.NewExpression;
        ...
        switch (node.getSymbol().getType()){
            ...
            case CPP14Parser.Not: // !expr
                ...
                if (parent instanceof UnaryOp) {
                    ...
                    ((UnaryOp) parent).setOperator(node.getText());
