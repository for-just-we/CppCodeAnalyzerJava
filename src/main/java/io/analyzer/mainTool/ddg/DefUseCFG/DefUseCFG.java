package io.analyzer.mainTool.ddg.DefUseCFG;
...
public class DefUseCFG
{
	...
	private MultiHashMap<Object, Object> symbolsUsed = new MultiHashMap<Object, Object>(); // key是语句，value是语句中使用的symbol
	private MultiHashMap<Object, Object> symbolsDefined = new MultiHashMap<Object, Object>(); // key是语句，value是语句中定义的symbol
	private MultiHashMap<Object, Object> parentBlocks = new MultiHashMap<Object, Object>(); // key是value的CFG后继结点
	private MultiHashMap<Object, Object> childBlocks = new MultiHashMap<Object, Object>(); // key是value的CFG前驱结点
